 ...
 * @author raihan
 */
public class MemberUpdateGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("To Update a Member, Please Enter Membership ID:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Member toUpdate = entityManager.find(Member.class, jTextField1.getText());
        MemberUpdateInformationGUI memberUpdateInformation = new MemberUpdateInformationGUI(toUpdate);
