 ...
 * @author raihan
 */
public class ReportsBookSearchResultsGUI extends javax.swing.JPanel {
    ...
    public ReportsBookSearchResultsGUI(JTextField title, JTextField authors, JTextField isbn, JTextField publisher, JTextField year) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(mainMenu, "Error! ReportsBookSearchResultsGUI");
        }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Books Search Results");

        jButton3.setBackground(new java.awt.Color(0, 204, 153));
        jButton3.setFont(new java.awt.Font("Helvetica Neue", 1, 14)); // NOI18N
        jButton3.setForeground(new java.awt.Color(0, 0, 0));
        jButton3.setText("Back To Search Function");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ReportsBookSearchGUI searchBook = new ReportsBookSearchGUI();
