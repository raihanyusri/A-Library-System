 ...
 * @author raihan
 */
public class ReportsBookOnLoanGUI extends javax.swing.JPanel {
    ...
    public ReportsBookOnLoanGUI() {
        ...
        try {
            ...
            Query query = entityManager.createNativeQuery("SELECT * FROM Book WHERE borrowDate IS NOT NULL AND returnDate IS NULL", Book.class);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Books on Loan Report");
